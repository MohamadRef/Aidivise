...
export default function Auth() {
  ...
  return (
    <div className={`max-w-md mx-auto mt-12 p-6 bg-white/10 backdrop-blur-md text-white rounded-xl shadow-xl ${message.includes('Invalid') ? 'animate-shake' : 'animate-fadeIn'}`}>
